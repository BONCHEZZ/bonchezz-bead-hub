    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          The bead you're looking for rolled off the table.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "Bonchezz Bead Hub — Handcrafted Accessories for Students" },
      {
        name: "description",
        content:
          "Bonchezz Bead Hub crafts one-of-a-kind bracelets, necklaces, watches, phone charms and waist beads on campus. Student prices, fast pickup.",
      },
      { name: "author", content: "Bonchezz Bead Hub" },
      { property: "og:title", content: "Bonchezz Bead Hub — Handcrafted Accessories" },
      {
        property: "og:description",
        content:
          "Handmade bead jewelry designed for students. Bracelets, necklaces, waist beads and more.",
      },
